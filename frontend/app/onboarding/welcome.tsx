    ...
    <SafeAreaView style={s.container}>
      <View style={s.content}>
        ...
        <View style={s.features}>
          <Text style={s.feature}>📚  Sync with Canvas to track assignments</Text>
          <Text style={s.feature}>🎯  Set daily goals and build streaks</Text>
          <Text style={s.feature}>🤖  AI study plans that break down homework</Text>
          <Text style={s.feature}>⏱️  Nudge you when you doom-scroll</Text>
          <Text style={s.feature}>🎙️  Jarvis-like daily briefings</Text>
        </View>

        <TouchableOpacity style={s.btn} onPress={() => router.push("/onboarding/register")}>
...
const s = StyleSheet.create({
  ...
  btn: { backgroundColor: "#7C6FF7", paddingVertical: 18, paddingHorizontal: 60, borderRadius: 14, marginTop: 40 },
